...
namespace E_Commerce_Bussiness.Repository
{
    public class OrderRepository : IOrderRepository
    {
        ...
        {
            var objHeader = await _context.OrderHeaders.FirstOrDefaultAsync(x => x.Id == id);
            if (objHeader != null)
            {
                ...
                _context.OrderHeaders.RemoveRange(objHeader);
                await _context.SaveChangesAsync();
                return 1;
            }
            return 0;
        ...
        public async Task<OrderDTO> Get(int id)
        {
            Order order = new()
            {
                ...
                OrderDetails = _context.OrderDetails.Where(x => x.Id == id),
            };
            if (order != null)
            {
